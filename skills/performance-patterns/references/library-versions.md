...
| `aesni_xts_256_encrypt_avx512` | `libcrypto.so.3` | OpenSSL | 3.3 | Major AVX-512 optimizations for AES-XTS-256 encryption in 3.3+; presence of this symbol means the optimized path is in use |
