...
description: >-
  ...
  cv-thundering-herd, mutex-to-rwlock, software prefetch (latency-exposed
  scan), CPU dispatch, library version upgrade, fast CRC32C, known
  algorithms (Cosine Similarity, Hamming Distance, Jaccard Distance),
